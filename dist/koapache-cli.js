...
(function (factory) {
    ...
    if ((typeof define === 'function')  &&  define.amd)
        define('koapache-cli', ["form-data","fs","@tech_query/node-toolkit","@babel/polyfill","koa","koa-logger","koa-body","@koa/cors","koa-static","internal-ip","opn","url","path","child_process","commander"], factory);
    else if (typeof module === 'object')
        return  module.exports = factory(require('form-data'),require('fs'),require('@tech_query/node-toolkit'),require('@babel/polyfill'),require('koa'),require('koa-logger'),require('koa-body'),require('@koa/cors'),require('koa-static'),require('internal-ip'),require('opn'),require('url'),require('path'),require('child_process'),require('commander'));
    else
        return  this['koapache-cli'] = factory(this['form-data'],this['fs'],this['@tech_query/node-toolkit'],this['@babel/polyfill'],this['koa'],this['koa-logger'],this['koa-body'],this['@koa/cors'],this['koa-static'],this['internal-ip'],this['opn'],this['url'],this['path'],this['child_process'],this['commander']);

})(function (form_data,fs,_tech_query_node_toolkit,_babel_polyfill,koa,koa_logger,koa_body,_koa_cors,koa_static,internal_ip,opn,url,path,child_process,commander) {
...
var _module_ = {
  ...
  './command': {
    ...
    factory: function factory(require, exports, module) {
      ...
      var manifest = (0, _nodeToolkit.packageOf)((0, _nodeToolkit.currentModulePath)()).meta,
          config = (0, _nodeToolkit.configOf)('koapache') || {};

      _commander.default.version(manifest.version).description(manifest.description).arguments('[dir]').option('-p, --port <value>', 'Listening port number (support Environment variable name)').option('--CORS', 'Enable CORS middleware').option('-o, --open [path]', 'Open the Index or specific page in default browser').parse(process.argv);

      var server = new _WebServer.default(_commander.default.args[0], isNaN(_commander.default.port) ? process.env[_commander.default.port] : _commander.default.port, _commander.default.CORS, config.proxy, _commander.default.open);
      server.localHost();
    }
  },
  'form-data': {
