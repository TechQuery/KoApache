...
(function (factory) {
    ...
    if ((typeof define === 'function')  &&  define.amd)
        define('koapache-cli', ["form-data","fs","url","http","https","babel-polyfill","koa","koa-logger","koa-body","@koa/cors","koa-static","internal-ip","opn","path","child_process","commander"], factory);
    else if (typeof module === 'object')
        return  module.exports = factory(require('form-data'),require('fs'),require('url'),require('http'),require('https'),require('babel-polyfill'),require('koa'),require('koa-logger'),require('koa-body'),require('@koa/cors'),require('koa-static'),require('internal-ip'),require('opn'),require('path'),require('child_process'),require('commander'));
    else
        return  this['koapache-cli'] = factory(this['form-data'],this['fs'],this['url'],this['http'],this['https'],this['babel-polyfill'],this['koa'],this['koa-logger'],this['koa-body'],this['@koa/cors'],this['koa-static'],this['internal-ip'],this['opn'],this['path'],this['child_process'],this['commander']);

})(function (form_data,fs,url,http,https,babel_polyfill,koa,koa_logger,koa_body,_koa_cors,koa_static,internal_ip,opn,path,child_process,commander) {
